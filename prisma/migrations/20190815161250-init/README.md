# Migration `20190815161250-init`

This migration has been generated by Rob Cameron at 8/15/2019, 4:12:50 PM.
...
You can use a specific Photon built for this migration (20190815161250-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190815161250-init'
